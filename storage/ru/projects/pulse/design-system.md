---
title: Pulse · Дизайн-система
description: Компонентная библиотека, семантические и primitive-токены, состояния интерактивных элементов, адаптивность и версионирование.
---
